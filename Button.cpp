...
namespace gui
{
	...
	/*void Button::handleEvent(sf::Event e, const sf::RenderWindow& window)
	{
		...
		case sf::Event::MouseButtonPressed:
			...
			{
			case sf::Mouse::Left:
				if (m_buttonSize == ButtonSize::Circle3 || m_buttonSize == ButtonSize::Circle2) // is a circle
				{
	...
	// first column has index=0
	int CircularButton::getPositionInRow() const
	{
		return m_positionInRow;
	}

	// first column has index=0
	void CircularButton::setPositionInRow(const int num)
	{
		m_positionInRow = num;
	}

	void CircularButton::setFunction(std::function<void(void)> func)
	{
		m_function = func;
	}

	void CircularButton::setText(const std::string& str)
	{
		m_text.setString(str);
	}

	void CircularButton::setTexture(const sf::Texture& tex)
	{
		m_button.setTexture(&tex);
	}
	...
	// first column has index=0
	int RectangularButton::getPositionInRow() const
	{
		return m_positionInRow;
	}

	// first column has index=0
	void RectangularButton::setPositionInRow(const int num)
	{
		m_positionInRow = num;
	}

	void RectangularButton::setFunction(std::function<void(void)> func)
	{
		m_function = func;
	}

	void RectangularButton::setText(const std::string& str)
	{
		m_text.setString(str);
	}

	void RectangularButton::setTexture(const sf::Texture& tex)
	{
		m_button.setTexture(&tex);
	}
